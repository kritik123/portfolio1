...
var credits = 'Please refresh to begin another terminal session.';
var love = 'Made with ❤ by Kritik Shivanshu';
var url_t = 'https://twitter.com/kritik123';
var url_fb = 'https://www.facebook.com/kritik.shivanshu.7';
var url_lin = 'https://linkedin.com/in/kritik-shivanshu-79385b167';
var url_git = 'https://github.com/siliconCupcake';
var url_m = 'mailto:kkshivanshu@gmail.com';
        ...
        if (e.keyCode == 13) {
            switch (usercommand[j].innerHTML) {
                ...
                case "contact -m":
                    ...
                    cursor[j].className = "remove-anim cursor";
                    command[j].readOnly = true;
                    response[j].innerHTML = "Drafting mail to kkshivanshu@gmail.com";
                    bash_history[j] = usercommand[j].innerHTML;
                    j++;
                    createNewCommandLine();
                    break;
